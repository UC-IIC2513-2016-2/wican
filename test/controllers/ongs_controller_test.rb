...
class OngsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ong" do
    assert_difference('Ong.count') do
      post ongs_url, params: { ong: { description: @ong.description, email: @ong.email, logo: @ong.logo, name: @ong.name, webpage: @ong.webpage } }
    end
  ...
  test "should update ong" do
    patch ong_url(@ong), params: { ong: { description: @ong.description, email: @ong.email, logo: @ong.logo, name: @ong.name, webpage: @ong.webpage } }
